...
|**BalloonTitle**|Gets or sets the title of the balloon tip to be show when the ShowBalloonTip method is called.|
|**BalloonText**|Gets or sets the text of the balloon tip to be show when the ShowBalloonTip method is called.|
|**BalloonIcon**|Gets or sets the icon of the balloon tip to be show when the ShowBalloonTip method is called.|
|**TrayContextMenu**|Gets or sets the context menu to be shown when the ContextMenuActivationMouseEvent is performed.|
|**PopupContent**|Gets or sets the control that is set as the content of the the popup which the notify icon shows when the PopupActivationMouseEvent is performed.|
...
|**PopupActivationMouseEvent**|Gets or sets the mouse action that must be performed over the notify icon to show a popup with RadNotifyIcon.PopupContent. The possible user actions can be *LeftClick*, *RightClick*, *MiddleClick*, *LeftDoubleClick*, *RightDoubleClick*, *MiddleDoubleClick*, or *All*. Default value is *LeftClick*.|
